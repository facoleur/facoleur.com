...
const Footer = () => {
  ...
  return (
    <footer className="mt-auto w-full bg-[url('/homepage/bg_footer.png')] bg-[length:100%_auto] px-4 pt-36 text-sm text-slate-600 dark:bg-slate-900/40 dark:text-slate-400">
      <div className="mx-auto flex max-w-5xl flex-col gap-6 md:items-start md:justify-between">
        ...
        <div className="flex flex-row gap-6 pt-12 pb-4 text-slate-500 md:mt-auto md:!h-full">
